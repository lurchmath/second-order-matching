...
Object.defineProperty(exports, "getVariablesIn", {
  enumerable: true,
  get: function get() {
    return _constraints.getVariablesIn;
  }
});
Object.defineProperty(exports, "occursFree", {
  enumerable: true,
  get: function get() {
    return _constraints.occursFree;
  }
});
Object.defineProperty(exports, "isFree", {
  enumerable: true,
  get: function get() {
    return _constraints.isFree;
  }
});
  ...
  (0, _createClass2["default"])(MatchingChallenge, [{
    ...
    value: function solutionSatisfiesBindingConstraints(solution) {
      return this.challengeList.bindingConstraints.every(function (binding_constraint) {
        ...
        var outer = (0, _constraints.getAPI)().isMetavariable(binding_constraint.outer) ? solution.lookup(binding_constraint.outer) : binding_constraint.outer;
        if (!outer) return true; // metavariable not instantiated yet; can't violate any constraints

        return !(0, _constraints.occursFree)(outer, inner);
      });
    }
    /**
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 18:
                ...
                if ((0, _constraints.getAPI)().isBinding(current_constraint.pattern) && (0, _constraints.getAPI)().isBinding(current_constraint.expression)) {
                  pattern_vars = (0, _constraints.getAPI)().bindingVariables(current_constraint.pattern);
                  expression_vars = (0, _constraints.getAPI)().bindingVariables(current_constraint.expression); // Get case checks number of arguments

                  for (i = 0; i < pattern_vars.length; i++) {
                    variable = pattern_vars[i];

                    if (!(0, _constraints.getAPI)().isMetavariable(variable)) {
              ...
              case 23:
                ...
                temp_mc_A = mc.clone();
                const_sub = new _constraints.Constraint((0, _constraints.getAPI)().getChildren(current_constraint.pattern)[1], (0, _constraints.makeConstantExpression)(temp_mc_A.challengeList.nextNewVariable(), current_constraint.expression)); // DEBUG( indent+'maybe add:', DEBUG_CONSTRAINT( const_sub ) )
              ...
              case 53:
                ...
                head = (0, _constraints.getAPI)().getChildren(current_constraint.pattern)[1];
                  ...
                  return _regenerator["default"].wrap(function _loop$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          temp_mc_B = mc.clone();
                          new_vars = (0, _constraints.getAPI)().getChildren(current_constraint.pattern).slice(2).map(function () {
              ...
              case 56:
                if (!(_i < (0, _constraints.getAPI)().getChildren(current_constraint.pattern).length)) {
                  _context2.next = 64;
                  break;
                }
              ...
              case 64:
                if (!((0, _constraints.getAPI)().isApplication(expression) || (0, _constraints.getAPI)().isBinding(expression))) {
                  _context2.next = 104;
                  break;
                }
                ...
                if ((0, _constraints.getAPI)().isApplication(expression)) {
                  temp_metavars = (0, _constraints.getAPI)().getChildren(expression).map(function () {
                    var new_var = temp_mc_C.challengeList.nextNewVariable();
                    (0, _constraints.getAPI)().setMetavariable(new_var);
                    return new_var;
                  });
                } else {
                  _new_var = temp_mc_C.challengeList.nextNewVariable();
                  (0, _constraints.getAPI)().setMetavariable(_new_var);
                ...
                imitation_sub = new _constraints.Constraint((0, _constraints.getAPI)().getChildren(current_constraint.pattern)[1], imitation_expr); // DEBUG( indent+'maybe add:', DEBUG_CONSTRAINT( imitation_expr ) )
              ...
              case 78:
                ...
                _loop2 = function _loop2(_i2) {
                  ...
                  var metavar_sub = _sol.firstSatisfying(function (c) {
                    return (0, _constraints.getAPI)().equal(c.pattern, metavar);
                  });
                  ...
                  if (metavar_sub != null) {
                    ...
                    for (var _i3 = 0; _i3 < _sol.length; _i3++) {
                      ...
                      var changed = metavar_sub.applyInstantiation(constraint.expression);
