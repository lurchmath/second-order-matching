...
exports.API = exports.OpenMath = void 0;

var _toConsumableArray2 = _interopRequireDefault(require("@babel/runtime/helpers/toConsumableArray"));

var _openmath = require("./openmath.js");

var OpenMath = _openmath.OM; // Define the metavariable symbol to be used as an attribute key, and its corresponding value

exports.OpenMath = OpenMath;
...
var API = {
   ...
   *   filtering predicate
   */
  filterSubexpressions: function filterSubexpressions(expr, filter) {
    return expr.descendantsSatisfying(filter);
  },
  ...
  getVariableName: function getVariableName(variable) {
    return API.isVariable(variable) ? variable.name : null;
  },
  ...
  bindingHead: function bindingHead(binding) {
    return API.isBinding(binding) ? binding.symbol : null;
  },
  ...
  bindingVariables: function bindingVariables(binding) {
    return API.isBinding(binding) ? binding.variables : null;
  },
  ...
  bindingBody: function bindingBody(binding) {
    return API.isBinding(binding) ? binding.body : null;
  },
   ...
   * @memberof OpenMathAPI
   */
  variableIsFree: function variableIsFree(variable, expression) {
    return variable.isFree(expression);
  },
  ////////////////////////////////////////////////////////////////////////////////
  ...
  setMetavariable: function setMetavariable(variable) {
    return API.isExpression(variable) && ['v', 'sy'].includes(variable.type) ? variable.setAttribute(metavariableSymbol, trueValue.copy()) : null;
  },
  ...
  isMetavariable: function isMetavariable(variable) {
    return API.isExpression(variable) && ['v', 'sy'].includes(variable.type) && variable.getAttribute(metavariableSymbol) != undefined && variable.getAttribute(metavariableSymbol).equals(trueValue);
  },
