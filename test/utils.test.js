...
describe('Expression Function Creators', () => {
    ...
    test('should correctly create imitations', () => {
        ...
        expect(imit.equals(
            quick('SecondOrderMatching.Meta[v1,v2,v3,SecondOrderMatching.Meta(_H1,v1,v2,v3)(SecondOrderMatching.Meta(_H2,v1,v2,v3),SecondOrderMatching.Meta(_H3,v1,v2,v3))]'))
        ).toBe(true);
    });
});
